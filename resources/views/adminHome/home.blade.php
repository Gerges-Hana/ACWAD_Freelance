        ...
        (function() {
            ...
            if (polarChart) {
                const polarChartVar = new Chart(polarChart, {
                    type: 'polarArea',
                    data: {
                        labels: ['الفروع', 'الاصناف', 'المبيعات', 'المصاريف', 'المديونيه', 'الطالبيات'],
                        datasets: [{
                            label: 'التقارير (عدد)',
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="card card-border-shadow-primary h-100">
                    <div class="card-body">
                        ...
                        <p class="mb-1">مجموع الحساب بالدولر :: 77$</p>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="col-6">
                                            <ul class="list-unstyled mb-0">
                                                <li class="d-flex mb-4 align-items-center">
                                                    <p class="mb-0 fw-medium me-2 website-analytics-text-bg">
                                                        {{ $bra_boxUsd }}</p>
                                                    <p class="mb-0"> حساب الفرع بالدولر</p>
                                                </li>
                                                <li class="d-flex align-items-center mb-2">
                                                    <p class="mb-0 fw-medium me-2 website-analytics-text-bg">
                                                        {{ $bra_boxTl }}</p>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-flex mb-4 align-items-center">
                                                <p class="mb-0 fw-medium me-2 website-analytics-text-bg">
                                                    {{ $usdOrdersCount_Count }}</p>
                                                <p class="mb-0">عدد الطلبيات </p>
                                            </li>
                                            <li class="d-flex align-items-center mb-2">
                                                <p class="mb-0 fw-medium me-2 website-analytics-text-bg">
                                                    {{ $usdOrdersAccept_Count }}</p>
                                    ...
                                    <div class="col-6">
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-flex mb-4 align-items-center">
                                                <p class="mb-0 fw-medium me-2 website-analytics-text-bg">
                                                    {{ $usdOrdersWait_Count }}</p>
                                                <p class="mb-0"> عدد الطلبيات في الانتظار </p>
                                            </li>
                                            <li class="d-flex align-items-center mb-2">
                                                <p class="mb-0 fw-medium me-2 website-analytics-text-bg">
                                                    {{ $tlOrdersCount_Count }}</p>
                                                <p class="mb-0"> عدد الطلبيات باليره </p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
