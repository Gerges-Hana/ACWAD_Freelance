...
@section('content')
    <div class="card">
        <div class="card-header">
            <h4 class="card_title_center">تعديل بيانات حساب hhhhhhالادمن </h4>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        @error('address')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>تتتتتتتتتتتتتتتتتتتتتتتتتتتتتتتت
                    {{-- الاضافة --}}
                    <div class="form-group text-center col-md-12">
                        <button class="btn btn-success" type="submit" id="do_add_item_card0">
